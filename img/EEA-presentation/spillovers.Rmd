...
- A new data set of European football at the game level, including 
 ...
 - actual result, location, betting market odds, end of league tables, transfer fees, and manager (coach) changes.
<br>  
